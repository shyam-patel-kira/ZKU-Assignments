...
contract ZKMint is ERC721, ERC721URIStorage, MerkleTree {
    ...
    /**
     * @param collectionName Name of token collection, e.g. "MyFirstNFT"
     * @param collectionSymbol Symbol of token collection, e.g. "MyFirstCollectibles"
