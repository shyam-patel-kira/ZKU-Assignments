...
void merkleProof_5_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void merkleProof_5_run(uint ctx_index,Circom_CalcWit* ctx);
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[8]); // line circom 13
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[2])) + 0);
{
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[4]); // line circom 13
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[2])) + 0);
{
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 13
while(Fr_isTrue(&expaux[0])){
{
...
Fr_geq(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 28
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
Fr_add(&expaux[4],&lvar[1],&circuitConstants[2]); // line circom 30
Fr_shl(&expaux[2],&circuitConstants[2],&expaux[4]); // line circom 30
Fr_lt(&expaux[0],&lvar[2],&expaux[2]); // line circom 30
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[1],&circuitConstants[4]); // line circom 31
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 28
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_geq(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 28
...
merkleProof_5_create(1,0,ctx,"main",0);
merkleProof_5_run(0,ctx);
}
